 ...
 * Date: Nov 13, 2005
 */
public class ShowAddMultiMBeanConfigAction extends BaseAction {
    /**
     * Just a forward action to build the complete URL and forward the same to
     * ShowMBeanAction.
     *
     * @param context
     * @param mapping
    ...
    public ActionForward execute(WebContext context,
        ...
        String managedObjLink = "/config/showMBeans.do?"
                ...
                + "&" + RequestParams.NAVIGATION + "="
                + Utils.urlEncode("Add Managed Objects");

        return new ActionForward(managedObjLink);
    }
}