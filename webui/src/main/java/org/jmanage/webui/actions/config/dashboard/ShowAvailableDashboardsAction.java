...
/**
 * Date: Aug 9, 2006 8:56:46 PM
 *
 * @author Shashank Bellary
 */
public class ShowAvailableDashboardsAction extends BaseAction {
    private DashboardRepository instance = DashboardRepository.getInstance();
    /**
     *
     * @param context
     * @param mapping
