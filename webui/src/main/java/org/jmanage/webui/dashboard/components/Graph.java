        ...
        try{
        	if(getType().equalsIgnoreCase("PieChart")){
        		...
        		StringBuffer graphComponent = 
        			new StringBuffer().append("<div id=\""+getId()+"\"><IFRAME width=\"500\" height=\"400\" style=\"border:0px\" src=\""+context.getServerPath()+"/app/drawPieChartDashboardComponent.do?").append(
